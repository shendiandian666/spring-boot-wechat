...
import com.sdd.job.AccessTokenJob;
import com.sdd.model.Menu;
import com.sdd.service.menu.MenuService;
...
public class MenuController {
	...
	private Logger logger = LogManager.getLogger(AccessTokenJob.class);

	// 查询全部菜单
	@RequestMapping(value = "/get", method = RequestMethod.GET)
	public String getMenu() {
		// 调用接口获取access_token
		String at = AccessTokenJob.accessToken.getToken();
